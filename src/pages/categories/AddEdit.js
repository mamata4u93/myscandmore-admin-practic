...
import { resetSingleData, feachSingleData, addNewData, editData } from '../../store/CategoriesRedux'
...
const AddEdit = () => {
    ...
    const isEditData = useSelector((state) => state.categorie.isEditData)
                            ...
                            <Col span={12} >
                                <Space>
                                    <Breadcrumb separator='>'>
                                        ...
                                        <Breadcrumb.Item>{params.id ? "Edit" : "Add"}{messages['manage.new']}</Breadcrumb.Item>
                                    </Breadcrumb>
                                </Space>
                            </Col>
                            <Col span={12} >
                        ...
                        <Row gutter={{ xs: 16, sm: 16, md: 32 }}>
                            ...
                            <Col xs={24} lg={20}>
                                ...
                                <Form.Item
                                    {...formItemLayout}
                                    name='icon'
                                    label={messages['sidebar.general.icon']}
                                    rules={[
                                        {
                                            required: true,
                                            message: [messages['error.iconName']],
                                        },
                                    ]}>
                                    <UploadImage />
                                </Form.Item>
                                ...
                                <Form.Item
                                    ...
                                    rules={[
                                        {
                                            required: true,
                                            message: ['Please Enter Categories Name'],
                                        },
                                    ]}>
