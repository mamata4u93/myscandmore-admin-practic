...
import { resetSingleData, feachSingleData, addNewData, editData } from '../../store/StoriesRedux'
...
const AddEdit = () => {
    ...
    const singleData = useSelector((state) => state.stories.singleData)
    const isEditData = useSelector((state) => state.stories.isEditData)
                                ...
                                <Col span={12} >
                                    <Space>
                                        <Breadcrumb separator='>'>
                                            <Breadcrumb.Item>{messages['sidebar.app.Managestories']}</Breadcrumb.Item>
