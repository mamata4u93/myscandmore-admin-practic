...
export const feachAllData = createAsyncThunk(
    ...
    async (params, { rejectWithValue }) => {
        const response = await apiGetCall(`/videos`, params)
...
export const addNewData = createAsyncThunk(
    'video/addNewData',
    async (params, { rejectWithValue }) => {
        const response = await apiPostCall(`/videos`, params)
        if (response.status === 'error') {
            return rejectWithValue(response.data)
        }
        return response?.data
...
export const editData = createAsyncThunk(
    'video/editData',
    async (params, { rejectWithValue }) => {
        const response = await apiPutCall(`/videos/${params?._id}`, params)
        if (response.status === 'error') {
            return rejectWithValue(response.data)
        }
        return response?.data
...
export const deleteData = createAsyncThunk(
    'video/deleteData',
    async (params, { rejectWithValue }) => {
        const response = await apiDeleteCall(`/videos/${params?._id}`, params)
        if (response.status === 'error') {
            return rejectWithValue(response.data)
        }
        return params
